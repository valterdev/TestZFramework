...
- - System/Core - модули ядра системы, необходимые для функционирования фреймворка
...
- <b>Hooks:</b> Добавлять ли файл с хуками (если планируется внедрять новые глобальные хуки в проект). Обратите внимание: Добавление глобальных хуков может вести к увеличение связности модулей. В дальнейшем может быть изменена.
